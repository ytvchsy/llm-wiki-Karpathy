...
Current build status for the Hermes + Obsidian + LLM wiki system.

## Current Phase

- Phase: building the Hermes + Obsidian + LLM wiki foundation
- Goal: turn this repository into a complete AI knowledge base workflow with Feishu ingestion and project documentation.
- Updated: 2026-05-14

## Done

- Initial LLM wiki scaffold created.
